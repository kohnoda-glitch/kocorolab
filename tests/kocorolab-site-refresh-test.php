...
$checks = array(
	...
	'profile includes education and career' => (
		...
		&& false !== strpos( $ja_profile, '教育留学' )
		&& false !== strpos( $ja_profile, '学びの旅' )
		&& false !== strpos( $ja_profile, 'u.lab 2x' )
		&& false !== strpos( $ja_profile, '公教育' )
		&& false !== strpos( $ja_profile, 'シュタイナー' )
		&& false === strpos( $ja_profile, 'オーナー' )
		...
		&& false !== strpos( $en_profile, 'public and ordinary education' )
