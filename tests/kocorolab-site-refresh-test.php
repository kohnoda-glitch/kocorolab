...
$checks = array(
	...
	'JA pubs include 2019 ETM poster' => ( false !== strpos( $ja_pubs, 'Embedding Systems Thinking in Philippine Education' ) && false !== strpos( $ja_pubs, '野田浩平' ) && false !== strpos( $ja_pubs, 'etm-2019-poster.jpg' ) ),
	'EN pubs include 2019 ETM poster' => false !== strpos( $en_pubs, 'Kohei Noda' ) && false !== strpos( $en_pubs, 'Embedding Systems Thinking in Philippine Education' ),
	'news includes 2019 Manila workshop photos' => ( false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'etm-2019-workshop.jpg' ) && false !== strpos( kocorolab_refresh_news_html( 'ja' ), '2019.05.24' ) && false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'プロジェクトメンバー' ) ),
