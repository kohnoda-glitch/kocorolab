...
$images = array( 'hero-horizon.jpg', 'spirit-sky.jpg', 'society-green.jpg', 'environment-ocean.jpg', 'kocoro-mark-light.png', 'kohei-noda.jpg' );
$img_ok = true;
...
$checks = array(
	...
	'portrait photo on profile, company, and MHQ LP' => (
		false !== strpos( file_get_contents( dirname( __DIR__ ) . '/wp-content/mu-plugins/kocorolab-site-refresh/front-page.php' ), "kocorolab_refresh_image_url( 'portrait' )" )
		&& false !== strpos( $ja_profile, 'kohei-noda.jpg' )
		&& false !== strpos( $ja_company, 'kohei-noda.jpg' )
		&& false !== strpos( $ja_lp, 'kohei-noda.jpg' )
		&& false !== strpos( $en_lp, 'Kohei Noda' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), 'kohei-noda.jpg' )
		&& 'images/kohei-noda.jpg' === kocorolab_refresh_image_url( 'portrait' )
	),
	...
	'ICE 2013 plenary links to the conference page' => (
		...
		&& false !== strpos( $ja_pubs, 'ice-2013-plenary.jpg' )
		&& false !== strpos( $en_pubs, 'conference' )
		&& false !== strpos( $ja_pubs, 'TIME-IMAGE-CREATIVITY WORKSHOP' )
		&& false !== strpos( $ja_pubs, 'Pinto Art Gallery' )
		&& false !== strpos( $ja_pubs, '武谷圭祐' )
		&& false !== strpos( $en_pubs, 'Keisuke Takeya' )
		&& false === strpos( $ja_pubs, 'Taketani' )
		&& false === strpos( $en_pubs, 'Taketani' )
		&& false !== strpos( $ja_pubs, 'antipolo-2013-workshop.jpg' )
		&& false !== strpos( $en_pubs, '7 December 2013' )
		&& is_readable( dirname( __DIR__ ) . '/wp-content/mu-plugins/kocorolab-site-refresh/files/ice-2013-plenary.jpg' )
		&& is_readable( dirname( __DIR__ ) . '/wp-content/mu-plugins/kocorolab-site-refresh/files/antipolo-2013-time-image-creativity-flyer.jpg' )
	),
	...
	'news list includes MHQ1 and Shubiki jinjibu press' => (
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'マニラでフィリピン教育プロジェクトを発表' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'etm-2019-poster.jpg' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'etm-2019-workshop.jpg' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '2019.05.24' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Philippine education project presented in Manila' )
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'jpa-2013-ss055.jpg' )
		...
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'TIME-IMAGE-CREATIVITY' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'ice-2013-plenary.jpg' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'ICE 2013' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'Heritage Hotel Manila' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'ice-2013-plenary.jpg' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'ice-2013-heritage-hotel.jpg' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'ICE 2013 plenary' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'TIME-IMAGE-CREATIVITY' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'Pinto Art Gallery' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '武谷圭祐' )
		...
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), '9_1_178' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), 'ICCS 2001' )
		&& false === strpos( kocorolab_refresh_news_html( 'en' ), 'Conference report on ICCS' )
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'llp-bps.net' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'フィリピン（セブ）留学、そして異文化体験' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '第139回' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Philippines (Cebu) study abroad' )
		&& false !== strpos( $ja_pubs, 'llp-bps.net' )
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'tokyo-tech-idea-league-2012.jpg' )
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'hu8z0vv3bb_i' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'U字カーブ' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'workplace will not move' )
		&& false !== strpos( $ja_pubs, 'hu8z0vv3bb_i' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'hu8z0vv3bb_i' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'sessions/198' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'YOKOHAMA CONNÉCT' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Tri-sector innovation' )
		&& false !== strpos( $ja_pubs, 'venturecafe-yokohamaconnect.org/sessions/198' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'sessions/198' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'detail-25752' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '千代崎' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Toga Chiyozaki' )
		&& false !== strpos( $ja_pubs, 'detail-25752.html' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'detail-25752' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'xll9i38vmmjf' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '志の力' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '福留大士' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'power of kokorozashi' )
		&& false !== strpos( $ja_pubs, 'xll9i38vmmjf' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'xll9i38vmmjf' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '20220917.html' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'IDGｓと人間性' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Inner Development Goals' )
		&& false !== strpos( $ja_pubs, 'mbcc-c.com/event/20220917.html' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), '20220917' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'events-ja/3263' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'カーボンプライシング' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'carbon pricing' )
		&& false !== strpos( $ja_pubs, 'can-japan.org/events-ja/3263' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), '3263' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), '9_1_178' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), 'ICCS 2001' )
		&& false === strpos( kocorolab_refresh_news_html( 'en' ), 'Conference report on ICCS' )
		&& false !== strpos( $ja_pubs, '9_1_178/_pdf' )
		&& false !== strpos( $en_pubs, 'Conference report on ICCS 2001' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), '9_1_178' )
		&& false !== strpos( $ja_pubs, 'kenkoxkoufukutalk' )
		&& false !== strpos( $en_pubs, 'health and happiness' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'peatix.com/event/1848747' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'shiawasesymposium.com/2021/wp/free/fr004' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '#myfuture 幸せな未来を描く' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'meeting my future self' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'shiawasesymposium.com/2021/wp/ws2/ws050' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'facebook.com/events/2831301047187478' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'フューチャーダイヤログ' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Future Dialogue' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), '86307345873' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), '657352' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), '830171369' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), '153177' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), 'kokuchpro' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), '1848747' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'ws050' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), 'carbonpricingchallenge' )
		&& false === strpos( kocorolab_refresh_page_html( 'mhqlp', 'ja' ), '古川元久' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'carbonpricingchallenge' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '古川元久議員訪問' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Motohisa Furukawa' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '斎藤健・経済産業大臣' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Ken Saito' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '河野太郎・行政改革担当大臣' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Taro Kono' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), '薗浦健太郎議員訪問' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Kentaro Sonoura' )
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'グローバル・カーボンプライシング・チャレンジ' )
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'Global Carbon Pricing Challenge' )
		&& false !== strpos( $ja_pubs, 'peatix.com/event/1848747' )
		&& false !== strpos( $en_pubs, 'meeting my future self' )
		&& false !== strpos( $ja_pubs, 'ws2/ws050' )
		&& false !== strpos( $en_pubs, 'Future Dialogue' )
		&& false !== strpos( $ja_pubs, 'carbonpricingchallenge' )
		&& false !== strpos( $en_pubs, 'Global Carbon Pricing Challenge' )
		&& false !== strpos( $ja_pubs, '古川元久議員訪問' )
		&& false !== strpos( $en_pubs, 'Motohisa Furukawa' )
		&& false !== strpos( $ja_pubs, '薗浦健太郎議員訪問' )
		&& false !== strpos( $en_pubs, 'Kentaro Sonoura' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), 'Nida' )
		&& false === strpos( kocorolab_refresh_news_html( 'ja' ), 'Taketani' )
	),
	...
	'news overlay still appears when WordPress posts exist' => ( function () {
		...
		return false !== strpos( $html, 'VUCA時代のストレス防衛術' ) && false !== strpos( $html, '/news/ideas/' )
			...
			&& false !== strpos( $html, 'ICE 2013' )
			&& false !== strpos( $html, 'TIME-IMAGE-CREATIVITY' )
			&& false !== strpos( $html, 'ice-2013-plenary.jpg' )
			&& false !== strpos( $html, 'antipolo-2013-workshop.jpg' )
			&& false !== strpos( $html, 'tokyo-tech-idea-league-2012.jpg' )
			...
			&& false !== strpos( $html, 'hu8z0vv3bb_i' )
			&& false !== strpos( $html, 'sessions/198' )
			&& false !== strpos( $html, 'detail-25752' )
			&& false !== strpos( $html, 'xll9i38vmmjf' )
			&& false !== strpos( $html, '20220917.html' )
			&& false !== strpos( $html, 'events-ja/3263' )
			&& false !== strpos( $html, 'peatix.com/event/1848747' )
			&& false !== strpos( $html, 'shiawasesymposium.com/2021/wp/ws2/ws050' )
			&& false !== strpos( $html, 'carbonpricingchallenge' )
			&& false !== strpos( $html, '古川元久議員訪問' )
			&& false === strpos( $html, '9_1_178' );
	} )(),
	...
	'JSON-LD pairs Kohei Noda with Kocorolab in both languages' => ( function () {
		...
		return isset( $ids['https://kocorolab.com/#kohei-noda'] )
			...
			&& false !== strpos( $blob, 'Q141298095' )
			&& false !== strpos( implode( ' ', kocorolab_refresh_person_same_as() ), 'Q141170552' )
			&& false === strpos( implode( ' ', kocorolab_refresh_person_same_as() ), 'Q141298095' )
			&& false !== strpos( implode( ' ', kocorolab_refresh_company_same_as() ), 'Q141298095' )
			&& false === strpos( implode( ' ', kocorolab_refresh_company_same_as() ), 'Q141170552' )
