...
$checks = array(
	...
	'contact section has mailto' => ( false !== strpos( $contact, 'mailto:info@knoda.xsrv.jp' ) && false !== strpos( $contact, 'id="direct-contact"' ) ),
	...
	'contact page has mailto and topics' => ( false !== strpos( $ja_contact, 'mailto:info@knoda.xsrv.jp' ) && false !== strpos( $ja_contact, '講演・研修依頼' ) ),
	'contact uses published company inbox not kocorolab.com' => ( false === strpos( $contact, 'info@kocorolab.com' ) && 'info@knoda.xsrv.jp' === kocorolab_refresh_contact_email() ),
