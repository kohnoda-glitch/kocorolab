...
$checks = array(
	...
	'ICE 2013 plenary links to the conference page' => (
		...
		&& false !== strpos( $ja_pubs, 'Keisuke Taketani' )
	...
	'news list includes MHQ1 and Shubiki jinjibu press' => (
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'ja' ), 'Keisuke Taketani' )
		...
		&& false !== strpos( kocorolab_refresh_news_html( 'en' ), 'with Keisuke Taketani' )
