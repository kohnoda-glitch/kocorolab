...
class TCDCE_Support {
	...
	public static function init_actions() {
		// is_plugin_active()を使う前に、plugin.php を読み込む
	...
	public static function register_settings() {
		...
		$heading_1 = __( 'Default editor for all users', 'tcd-classic-editor' );
		$heading_2 = __( 'Allow users to switch editors', 'tcd-classic-editor' );
	...
	public static function settings_1( $user_id = 0 ) {
		...
		<div class="classic-editor-options">
			<p>
				...
				<label for="classic-editor-classic"><?php esc_html_e( 'Classic editor', 'tcd-classic-editor' ); ?></label>
			</p>
			<p>
				...
				<label for="classic-editor-block"><?php esc_html_e( 'Block editor', 'tcd-classic-editor' ); ?></label>
			</p>
		</div>
		<script>
	...
	public static function settings_2() {
		...
		<div class="classic-editor-options">
			<p>
				...
				<label for="classic-editor-allow"><?php esc_html_e( 'Yes', 'tcd-classic-editor' ); ?></label>
			</p>
			<p>
				...
				<label for="classic-editor-disallow"><?php esc_html_e( 'No', 'tcd-classic-editor' ); ?></label>
			</p>
		</div>
		<?php
	}
	...
	public static function user_settings( $user = null ) {
		...
		<table class="form-table">
			<tr class="classic-editor-user-options">
				<th scope="row"><?php esc_html_e( 'Default Editor', 'tcd-classic-editor' ); ?></th>
				<td>
	...
	public static function network_settings() {
		...
		?>
		<h2 id="classic-editor-options"><?php esc_html_e( 'Editor Settings', 'tcd-classic-editor' ); ?></h2>
		<table class="form-table">
			<?php wp_nonce_field( 'allow-site-admin-settings', 'classic-editor-network-settings' ); ?>
			<tr>
				<th scope="row"><?php esc_html_e( 'Default editor for all sites', 'tcd-classic-editor' ); ?></th>
				<td>
					<p>
			...
			<tr>
				<th scope="row"><?php esc_html_e( 'Change settings', 'tcd-classic-editor' ); ?></th>
				<td>
					...
					<label for="classic-editor-allow-sites"><?php esc_html_e( 'Allow site admins to change settings', 'tcd-classic-editor' ); ?></label>
					<p class="description"><?php esc_html_e( 'By default the block editor is replaced with the classic editor and users cannot switch editors.', 'tcd-classic-editor' ); ?></p>
				</td>
			</tr>
		</table>
		<?php
	...
	public static function add_settings_link( $links, $file ) {
		...
		if ( $file === 'classic-editor/classic-editor.php' && ! $settings['hide-settings-ui'] && current_user_can( 'manage_options' ) ) {
			...
			$links = (array) $links;
			$links[] = sprintf( '<a href="%s">%s</a>', $url, __( 'Settings', 'tcd-classic-editor' ) );
		}
	...
	public static function add_post_state( $post_states, $post ) {
		...
		if ( ! $editors['classic_editor'] && ! $editors['block_editor'] ) {
			...
			$state = '<span class="classic-editor-forced-state">' . __( 'classic editor', 'tcd-classic-editor' ) . '</span>';
		} elseif ( ! $editors['classic_editor'] && $editors['block_editor'] ) {
			// Forced to block editor.
			$state = '<span class="classic-editor-forced-state">' . __( 'block editor', 'tcd-classic-editor' ) . '</span>';
		} else {
...
add_action( 'plugins_loaded', array( 'TCDCE_Support', 'init_actions' ) );
