<?php
 ...
 // Constructor //
	function __construct() {
		parent::__construct(
			'google_search', // ID
			__( 'Google Custom Search (tcd-w ver)', 'tcd-w' ), // Name
			array( 
...
?>
<p style="margin-bottom:5px;"><?php _e('If you want to use google custom search for your wordpress, enter your google custom search ID.<br /><a href="https://cse.google.com/cse/" target="_blank">Read more about Google custom search page.</a>', 'tcd-w');  ?></p>
<p>
