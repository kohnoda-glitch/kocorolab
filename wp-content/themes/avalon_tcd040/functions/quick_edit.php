...
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post1" value="on" /> <?php _e( 'Show this post for recommend post 1.', 'tcd-w' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post2" value="on" /> <?php _e( 'Show this post for recommend post 2.', 'tcd-w' );  ?></label>
...
function custom_quick_edit_values( $actions, $post ) {
    ...
    if ( $post->post_type == 'post' ) {
		$meta_keys = array_merge( $meta_keys,  array( 'recommend_post1', 'recommend_post2', 'pickup_post', 'featured_post' ) );
	}
