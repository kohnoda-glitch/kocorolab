...
function add_css_to_post_custom_css_hooks() {
    add_meta_box('custom_css', __('Custom CSS for this post', 'tcd-w'), 'add_css_to_post_custom_css_input', 'post', 'normal', 'high');
    add_meta_box('custom_css', __('Custom CSS for this page', 'tcd-w'), 'add_css_to_post_custom_css_input', 'page', 'normal', 'high');
    add_meta_box('custom_css', __('Custom CSS for this news', 'tcd-w'), 'add_css_to_post_custom_css_input', 'news', 'normal', 'high');
}
