...
function page_builder_meta_box() {
    add_meta_box(
        ...
        array('page','post','project','event','info'),// post type
        'normal',// context
        'high'// priority
    );
}
...
?>
  ...
  <div class="pb_desc">
   <div class="alert alert-danger"><?php _e('This page builder function has been deprecated. This function will be deleted in the future version. To use the page builder function, please use the new page builder function in the editor.', 'tcd-w'); ?></div>
