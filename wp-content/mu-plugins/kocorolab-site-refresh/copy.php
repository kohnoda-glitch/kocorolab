...
function kocorolab_refresh_copy( $lang = 'ja' ) {
	$ja = array(
		...
		'bio_p1_ja'      => '東京工業大学大学院修了、博士（学術 / 認知科学）。人事・チェンジマネジメントと適性検査の事業開発を経て独立し、メンタルヘルス検査 MHQ を発売。フィリピン・ドゥマゲテでは Starting Point English Academy（SPEA）校長として、街での実践型の学びと現地の組織運営に携わり、グローバル人材育成と人事統括にも従事。現地の州立大学教育学部の教員とともに、バリのグリーン・スクールを参考にしつつ、インターナショナルスクールに誰もが通えるわけではないので、現地の人も通える学びの場を目指し、教育留学や地域での学びの旅も行っていました。2019年以降は Presencing Institute の Societal Transformation Lab（u.lab 2x）で教育の試作に加わり、フィリピンではオンラインだけでなく、ジュリー・アーツやオットー・シャーマーを招いた現地のワークショップも行いました。マニラのシュタイナー学校の関係者を含む教育関係者と進めるなかで、公教育や一般の学びがついてこないと社会は変わらない、という当初からの課題を改めて感じ、加速させる予定でしたが、新型コロナウイルスの流行で足が止まりました。事業会社の人事責任者を経て、株式会社グロービス、グロービス経営大学院 専任教員。MIT経営大学院グローバルプログラム IDEAS Asia Pacific 修了、同リージョナル・ファカルティ、株式会社ココロラボ代表取締役。',
		...
		'bio_p1_en'      => 'Ph.D. in Cognitive Science, Tokyo Institute of Technology. After HR and change-management consulting and work in talent and assessment, he launched the MHQ mental health questionnaire. In Dumaguete, Philippines, he served as principal of Starting Point English Academy (SPEA), working on experiential learning in the city and local operations, and also led global talent development and HR. He worked with a faculty member of the local state university’s college of education. Drawing on Bali’s Green School, they aimed at a place local families could also attend, since an international school is not open to everyone, and also ran educational study-abroad and place-based learning journeys. From 2019 he joined an education prototype in the Presencing Institute’s Societal Transformation Lab (u.lab 2x). In the Philippines this included in-person workshops, with Julie Arts and Otto Scharmer invited, not only online work. Working with Manila educators, including people around a Steiner school, he again felt the original problem: society does not change if public and ordinary education are left behind. They had meant to accelerate this, until the COVID-19 pandemic stopped it. He later served as head of HR in operating companies, then joined GLOBIS Corporation. He is Associate Professor and Research Faculty at Globis University Graduate School of Management, Regional Faculty for MIT Sloan Global Program IDEAS Asia Pacific, and Representative Director at Kocorolab Inc.',
