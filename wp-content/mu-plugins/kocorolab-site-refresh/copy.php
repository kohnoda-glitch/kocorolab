...
function kocorolab_refresh_copy( $lang = 'ja' ) {
	$ja = array(
		...
		'company_note'   => '法人番号 9011001058869。横浜市磯子区の認知科学研究所。英語名は Kocorolab / Kocoro Laboratory（公式サイト kocorolab.com）。Cocorolab / Cocoro Laboratory と打たれることもあります。東京都の保育園（cocorolab.net）や港区の株式会社COCORO Lab（cocorolab.co.jp）とは別会社です。',
		'company_m_h'    => 'ミッション',
	...
	$en = array(
		...
		'company_note'   => 'Corporate number 9011001058869. Official Latin name: Kocorolab / Kocoro Laboratory (kocorolab.com). Also typed as Cocorolab / Cocoro Laboratory. Not the Tokyo nursery at cocorolab.net, and not COCORO Lab at cocorolab.co.jp.',
		'company_m_h'    => 'Mission',
