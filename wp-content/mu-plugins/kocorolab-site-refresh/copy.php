...
function kocorolab_refresh_copy( $lang = 'ja' ) {
	$ja = array(
		...
		'bio_p1_ja'      => '東京工業大学大学院修了、博士（学術 / 認知科学）。人事・チェンジマネジメントと適性検査の事業開発を経て独立し、メンタルヘルス検査 MHQ を発売。フィリピン・ドゥマゲテでは Starting Point English Academy（SPEA）校長として、街での実践型の学びと現地の組織運営に携わり、グローバル人材育成と人事統括にも従事。現地の州立大学教育学部の教員（幼稚園も運営）とともに、バリのグリーン・スクールを参考に、K-12、将来は大学までの学びの場を目指し、教育留学や SDGs・社会起業のラーニングジャーニーも行っていました。事業会社の人事責任者を経て、株式会社グロービス、グロービス経営大学院 専任教員。MIT経営大学院グローバルプログラム IDEAS Asia Pacific 修了、同リージョナル・ファカルティ、株式会社ココロラボ代表取締役。',
