...
<!-- generator="WordPress/6.4.3" created="2020-10-08 12:00" -->
<rss version="2.0"
...
<channel>
	...
	<item>
		...
		<wp:post_date><![CDATA[2020-10-08 12:00:00]]></wp:post_date>
		<wp:post_date_gmt><![CDATA[2020-10-08 03:00:00]]></wp:post_date_gmt>
		<wp:post_modified><![CDATA[2020-10-08 12:00:00]]></wp:post_modified>
		<wp:post_modified_gmt><![CDATA[2020-10-08 03:00:00]]></wp:post_modified_gmt>
		<wp:comment_status><![CDATA[closed]]></wp:comment_status>
		<wp:ping_status><![CDATA[closed]]></wp:ping_status>
		<wp:post_name><![CDATA[sdgs-goal-1-africa]]></wp:post_name>
...
def write_import_copies(xml_path: Path) -> None:
    """Keep the easy-to-download names in sync with the dated WXR file."""
    easy = xml_path.with_name("note-import.xml")
    easy.write_bytes(xml_path.read_bytes())
    zpath = xml_path.with_name("note-import.zip")
    with zipfile.ZipFile(zpath, "w", compression=zipfile.ZIP_DEFLATED) as zf:
        zf.write(easy, arcname="note-import.xml")
    print("wrote", easy)
    print("wrote", zpath)
