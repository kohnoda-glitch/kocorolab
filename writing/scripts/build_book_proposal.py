...
BLOCKS: list[tuple[str, str]] = [
    ...
    ("meta", "野田浩平（主著）／飯田史也／猪原健弘　｜　共同発起人：松岡良彦"),
    ...
    (
        "p",
        "野田浩平は主著として、認知科学とリーダーシップ教育の側から二人をつなぐ。松岡良彦は共同発起人である。飯田・猪原の著者表記は本人と調整する。顔ぶれそのものが、すでに本書の理由である。",
    ),
    ("h1", "2. タイトル"),
    (
        "p",
    ...
    (
        "p",
        "売りは飯田と猪原の経歴である。主著は野田。著者表記は本人と調整する。松岡は共同発起人であり、執筆の範囲はこれから決める。",
    ),
    ("h2", "飯田史也"),
    (
        "p",
