...
BLOCKS: list[tuple[str, str]] = [
    ...
    (
        "p",
        "AIが、いわゆる「頭のよさ」を安くした。残るのは、身体、感情、対人、現場で使う言葉といった、包括的な能力である。本書はそれを、親・教師・経営者に渡す。多重知能は地図のひとつであり、本の看板ではない。感情を捨てる本でもない。",
    ),
    ("h2", "書店で手に取る理由"),
    ("li", "仕事のコストは下げろ。人間のコストは上げろ。"),
    ("li", "ChatGPTに「部下の気持ち」を聞くな。会いに行け。"),
    ("li", "昭和の全部を戻せ、ではない。捨てたはずの会う・雑談・世話・失敗の共有を、設計し直せ。"),
    ("li", "STEMの先に残るのは、頭のよさ以外の能力である。感情も、その一部である。"),
    ("h1", "3. なぜ今か"),
    (
        "p",
    ...
    (
        "p",
        "身体、感情、人と場。こうした力は、経営教育の議論でも長く言われてきた。教育学でも、エリート教育の見直しでも、以前から出ている。特定の大学や国際機関の名前を並べれば新しく見えるが、新しさはそこではない。本書は、その再発見を繰り返さない。書くのは、AIが論理と知識を安くしたあとに、日本の家庭・学校・職場で、どの力をどう育てるかである。",
    ),
    (
        "p",
    ...
    (
        "p",
        "若手には「昭和」という言葉のアレルギーがある。だから昭和は入口のコピーに使い、本文は包括的な能力——身体、感情、人と場——で読ませる。タイトルは第一案以外でもよい。中身は変えない。",
    ),
    ("h1", "5. 中心概念"),
    (
        "p",
        "3名、ないし4名をつなぐのは、感情の教科書でも、ひとつの理論の解説書でもない。頭のよさ以外の、包括的な能力である。多重知能は、その代表的な整理のひとつにすぎない。身体、対人、内面、言語、感情。IQやSTEMで測る力は、その一部でしかない。",
    ),
    (
        "p",
        "顔ぶれは、その現場にいる。飯田は身体とものづくり（身体性ロボット・人工知能）。猪原は人と集団で決めること（合意形成・特別活動）。野田は認知科学と学びの設計。松岡は言語と現場の学び（RLE、子どもの英語教育）。感情や機嫌は、ここで必ず出てくる。ただし本の全部を感情に還元しない。",
    ),
    ("h2", "現場で使う地図"),
    ("li", "感じる——身体の変化や、まだ言葉になっていない感覚に気づく。"),
    ("li", "読み解く——怒り、不安、空腹、疲労を、取り違えない。"),
    ("li", "言葉にする——攻撃でも沈黙でもなく、共有できる形にする。"),
    ("li", "余白をつくる——衝動と行動のあいだに、選択肢を置く。"),
    ("li", "共に決める——違う価値観のまま、合意に乗せる。"),
    ("h2", "5つの層"),
    ...
    (
        "p",
        "認知科学者（博士）。株式会社ココロラボ代表取締役。グロービス経営大学院専任教員。MIT IDEAS Asia Pacific Regional Faculty。認知科学とリーダーシップ教育から、身体・感情・関係を含む学びを設計する。",
    ),
