...
BLOCKS: list[tuple[str, str]] = [
    ...
    ("meta", "売り：飯田（ケンブリッジ／東大・身体性ロボット・人工知能）× 猪原（東京科学大・中教審）"),
    ("meta", "2026年9月"),
    ("h1", "1. 売り"),
    (
        "p",
    ...
    ("h2", "飯田史也——ケンブリッジ大学・東京大学（理系）。身体性ロボットと人工知能"),
    (
        "p",
    ...
    ("li", "仕事は速くなった。人が動かない。"),
    ("li", "会うことを、設計し直す"),
    ("h2", "第1章　「感情的になるな」が、いちばん危ない（野田）"),
    ("li", "ChatGPTに「部下の気持ち」を聞くな"),
    ("li", "データは手段を選ぶ。何を大切にするかは、人が決める"),
    ("li", "頭がいい人ほど、先に折れる"),
    ("h2", "第2章　AIは、お腹が空いて不機嫌になれない（飯田）"),
    ("li", "ロボット研究者が、胃腸を見る理由"),
    ("li", "画面の前の論理が、こぼしているもの"),
    ("li", "予測が外れたとき、人は学び始める"),
    ("h2", "第3章　あの不機嫌の正体は、だいたい空腹である（野田）"),
    ("li", "怒りと疲労を、取り違えない"),
    ("li", "0.5秒の余白をつくる"),
    ("li", "沈黙と爆発は、同じ罠の両側である"),
    ("h2", "第4章　リーダーの機嫌が、場の頭を悪くする（野田×猪原）"),
    ("li", "「何でも言っていい」は、安全ではない"),
    ("li", "会う、雑談、世話、失敗の共有"),
    ("li", "上機嫌の場は、設計できる"),
    ("h2", "第5章　正しいことを言っても、人は動かない（猪原）"),
